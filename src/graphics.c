 ...
 *
 * This file is unused. It was provided as part of an assignment's
 * starter code, and came with many issues and defects. It has been
 * copied into "engine.c"/"engine.h", and cleanups/feature work was
 * continued in that file.
*/
